    ...
    <ModalShell title="Add post" onClose={onClose}>
      <form className="detail-account-form" onSubmit={formik.handleSubmit}>
        <div className="detail-form-grid">
          ...
          <label className="detail-form-field"><span className="detail-form-label">Publish at (EDT)</span><input className="detail-form-input" name="publish_at" type="datetime-local" value={formik.values.publish_at} onChange={formik.handleChange} onBlur={formik.handleBlur} required /><span className="detail-post-subtle">Interpreted as America/New_York time.</span></label>
