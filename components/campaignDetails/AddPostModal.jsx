    ...
    <ModalShell title="Add post" onClose={onClose}>
      <form className="detail-account-form" onSubmit={formik.handleSubmit}>
        <div className="detail-form-grid">
          ...
          <label className="detail-form-field detail-form-field-wide"><span className="detail-form-label">Titles (CSV)</span><textarea className="detail-form-input detail-form-textarea" name="titleVariants" value={formik.values.titleVariants} onChange={formik.handleChange} onBlur={formik.handleBlur} placeholder="Title one, Title two, Title three" rows={3} required /><span className="detail-post-subtle">Enter comma-separated titles. For auto-scan previews, add one title per target account.</span></label>
        ...
        {formik.touched.titleVariants && formik.errors.titleVariants ? <p className="detail-form-message detail-form-message-error">{formik.errors.titleVariants}</p> : null}
